...
//       icon = "",
//       error,
//       parentDiv = "bg-white p-4 rounded-lg my-3 shadow-lg shadow-gray-500",
//       ...props
//     },
//     ref
//   ) => {
...
//           <input
//             type={type}
//             className={`w-2/3 text-black ${inpClass} bg-transparent outline-none focus:outline-none placeholder:text-black`}
//             {...props}
//             id={id}
//             ref={ref}
//           />
